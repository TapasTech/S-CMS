export default {
  ...
  LIB: {
    ...
    SHOW: 'LIB_SHOW',
    UPDATE: 'LIB_UPDATE',
    INTERNAL_ARTICLES_FETCHING: 'LIB_INTERNAL_ARTICLES_FETCHING',
    INTERNAL_ARTICLES_FETCHIED: 'LIB_INTERNAL_ARTICLES_FETCHED',
    INTERNAL_ARTICLES_FETCH_FAILED: 'LIB_INTERNAL_ARTICLES_FETCH_FAILED'
  },
  CFG: {
    description: 'configs',
    DRA: {
